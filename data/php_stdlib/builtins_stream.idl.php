...
function stream_context_create($options = null_array, $params = null_array) { }
function stream_context_get_default($options = null_array) { }
function stream_context_get_options($stream_or_context) { }
function stream_context_set_option($stream_or_context, $wrapper, $option = null_string, $value = null_variant) { }
...
function stream_encoding($stream, $encoding = null_string) { }
...
function stream_get_line($handle, $length = 0, $ending = null_string) { }
...
function stream_socket_recvfrom($socket, $length, $flags = 0, $address = null_string) { }
function stream_socket_sendto($socket, $data, $flags = 0, $address = null_string) { }
