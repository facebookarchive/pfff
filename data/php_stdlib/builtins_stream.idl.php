...
function stream_resolve_include_path($filename, $context = null_resource) { }
...
function stream_socket_server($local_socket, &$errnum = null, &$errstr = null, $flags = 0, $context = null_resource) { }
function stream_socket_client($remote_socket, &$errnum = null, &$errstr = null, $timeout = 0.0, $flags = 0, $context = null_resource) { }
function stream_socket_enable_crypto($stream, $enable, $crypto_type = 0, $session_stream = null_resource) { }
