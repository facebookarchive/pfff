...
function memcache_get_stats($memcache, $type = null_string, $slabid = 0, $limit = 100) { }
function memcache_get_extended_stats($memcache, $type = null_string, $slabid = 0, $limit = 100) { }
...
class Memcache {
 ...
 function connect($host, $port = 0, $timeout = 0, $timeoutms = 0) { }
 function pconnect($host, $port = 0, $timeout = 0, $timeoutms = 0) { }
 ...
 function delete($key, $expire = 0) { }
 function increment($key, $offset = 1) { }
 function decrement($key, $offset = 1) { }
 function getversion() { }
 function flush($expire = 0) { }
 function setoptimeout($timeoutms) { }
 function close() { }
 function getserverstatus($host, $port = 0) { }
 function setcompressthreshold($threshold, $min_savings = 0.2) { }
 function getstats($type = null_string, $slabid = 0, $limit = 100) { }
 function getextendedstats($type = null_string, $slabid = 0, $limit = 100) { }
 function setserverparams($host, $port = 11211, $timeout = 0, $retry_interval = 0, $status = true, $failure_callback = null_variant) { }
 function addserver($host, $port = 11211, $persistent = false, $weight = 0, $timeout = 0, $retry_interval = 0, $status = true, $failure_callback = null_variant, $timeoutms = 0) { }
 function __destruct() { }
}
