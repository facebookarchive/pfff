...
function ldap_connect($hostname = null_string, $port = 389) { }
...
function ldap_bind($link, $bind_rdn = null_string, $bind_password = null_string) { }
...
function ldap_list($link, $base_dn, $filter, $attributes = null_array, $attrsonly = 0, $sizelimit = -1, $timelimit = -1, $deref = -1) { }
function ldap_read($link, $base_dn, $filter, $attributes = null_array, $attrsonly = 0, $sizelimit = -1, $timelimit = -1, $deref = -1) { }
function ldap_search($link, $base_dn, $filter, $attributes = null_array, $attrsonly = 0, $sizelimit = -1, $timelimit = -1, $deref = -1) { }
