...
function image2wbmp($image, $filename = null_string, $threshold = -1) { }
...
function imagegd2($image, $filename = null_string, $chunk_size = 0, $type = 0) { }
function imagegd($image, $filename = null_string) { }
function imagegif($image, $filename = null_string) { }
...
function imagejpeg($image, $filename = null_string, $quality = -1) { }
...
function imagepng($image, $filename = null_string, $quality = -1, $filters = -1) { }
...
function imagetypes() { }
function imagewbmp($image, $filename = null_string, $foreground = -1) { }
function imagexbm($image, $filename = null_string, $foreground = -1) { }
...
function exif_read_data($filename, $sections = null_string, $arrays = false, $thumbnail = false) { }
function read_exif_data($filename, $sections = null_string, $arrays = false, $thumbnail = false) { }
