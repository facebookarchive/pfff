...
function fseek($handle, $offset, $whence = k_SEEK_SET) { }
...
function fgetss($handle, $length = 0, $allowable_tags = null_string) { }
...
function parse_ini_file($filename, $process_sections = false, $scanner_mode = k_INI_SCANNER_NORMAL) { }
function parse_ini_string($ini, $process_sections = false, $scanner_mode = k_INI_SCANNER_NORMAL) { }
...
function basename($path, $suffix = null_string) { }
