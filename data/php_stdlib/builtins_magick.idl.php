...
function newpixelwand($imagemagick_col_str = null_string) { }
...
function drawsetstrokedasharray($drw_wnd, $dash_array = null_array) { }
...
function magicknewimage($mgck_wnd, $width, $height, $imagemagick_col_str = null_string) { }
...
function magickpainttransparentimage($mgck_wnd, $target, $opacity = k_MW_TransparentOpacity, $fuzz = 0.0) { }
...
function magickprofileimage($mgck_wnd, $name, $profile = null_string) { }
...
function magicksetfilename($mgck_wnd, $filename = null_string) { }
...
function magicksetimagefilename($mgck_wnd, $filename = null_string) { }
