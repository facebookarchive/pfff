...
function gzencode($data, $level = -1, $encoding_mode = k_FORCE_GZIP) { }
...
function gzgetss($zp, $length = 0, $allowable_tags = null_string) { }
function gzread($zp, $length = 0) { }
function gzpassthru($zp) { }
function gzseek($zp, $offset, $whence = k_SEEK_SET) { }
function gztell($zp) { }
