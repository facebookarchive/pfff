...
type graph = (string * Common.StringSet.t) list

val emptyGraph : graph

val divideGraph : graph -> string -> Common.StringSet.t * graph

val addEdge :  graph -> string -> string -> graph
val addEdges :  graph -> string -> Common.StringSet.t -> graph
val removeEdge :  graph -> string -> string -> graph
val removeEdges :  graph -> string -> Common.StringSet.t -> graph
...
val targetsOf : graph -> string -> Common.StringSet.t
