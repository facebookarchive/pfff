...
object (self)
  ...
  method writeString s=
    debug ("TBinaryProtocol: writeString: " ^ s);
  ...
  method writeMessageBegin (n,t,s) =
    debug "TBinaryProtocol: writeMessageBegin";
