...
val json_of_files_coverage: files_coverage -> Json_type.json_type

val tests_coverage_of_json: Json_type.json_type -> tests_coverage
val files_coverage_of_json: Json_type.json_type -> files_coverage

(* shortcuts *)
val save_tests_coverage: tests_coverage -> Common.filename -> unit
val load_tests_coverage: Common.filename -> tests_coverage

val save_files_coverage: files_coverage -> Common.filename -> unit
val load_files_coverage: Common.filename -> files_coverage
