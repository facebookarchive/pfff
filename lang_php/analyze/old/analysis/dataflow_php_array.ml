...
let var_name_of_lval lval = 
  ...
  | (Pil.TodoLvalue _|Pil.DynamicObjAccess (_, _)) -> raise Todo
...
let node_contain_funcall func_name n = 
  ...
  | CFG.Instr instr ->
      ...
      |(Pil.TodoInstr _|Pil.AssignRef (_, _)) -> raise Todo
      )
  | _ -> false
